...
func TestExtractAttributes(t *testing.T) {
	tests := map[string]struct {
		...
		"SimplePing": {
			...
			a: Attribute{
				Hook: pUint8(3), Prefix: pString(""), HwProtocol: pUint16(unix.ETH_P_IP), UID: pUint32(0x03e8), GID: pUint32(0x03e8), OutDev: pUint32(0x03),
		...
		"IPv6 TCP packet with conntrack data": {
			...
			a: Attribute{
				Hook: pUint8(1), Prefix: pString("testprefix: "), HwProtocol: pUint16(unix.ETH_P_IPV6), UID: pUint32(33), GID: pUint32(33), InDev: pUint32(0x02),
